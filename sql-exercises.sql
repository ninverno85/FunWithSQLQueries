...
Country = 'Mexico' or Country = 'Sweden' or Country = 'Germany')

/*6. Return a count of the number of discontinued products in the Products table.*/
select COUNT(*) as Discontinued 
from Products
...
inner join Customers
On Orders.CustomerID = Customers.CustomerID
where Orders.CustomerID != Customers.ContactName

/*14.Add a shipper named 'Amazon' to the Shippers table using SQL.*/
insert into Shippers (CompanyName, Phone)
values ('Amazon', '(888) 280-4331');
...
select Shippers.CompanyName, Orders.Freight, Orders.ShipVia
from Shippers
inner join Orders
on Shippers.ShipperID = Orders.ShipVia
where Round(Freight, -1) > 0;
...
insert into Customers (CustomerID, ContactName, CompanyName)
 values ('NICK', 'Nick Inverno', 'NSI Inc')

insert into Orders (CustomerID, OrderDate)
values ('NICK', '2017-05-22')
